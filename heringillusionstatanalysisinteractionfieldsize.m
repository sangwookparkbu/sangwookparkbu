...
fileName2 = ['upperangles' 'interactionfieldsize' num2str(1.2) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
    
    loading2 = load(fileName2);
    loading2.angle(1:5,:) = [];
    loading2.angle(end-4:end,:) = [];
    
fileName3 = ['upperangles' 'interactionfieldsize' num2str(1.4) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
...
fileName4 = ['upperangles' 'interactionfieldsize' num2str(1.6) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
    
    loading4 = load(fileName4);
    loading4.angle(1:5,:) = [];
    loading4.angle(end-4:end,:) = [];
    
fileName5 = ['upperangles' 'interactionfieldsize' num2str(1.8) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
    
    loading5 = load(fileName5);
    loading5.angle(1:5,:) = [];
    loading5.angle(end-4:end,:) = [];

fileName6 = ['upperangles' 'interactionfieldsize' num2str(2) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
    
    loading6 = load(fileName6);
    loading6.angle(1:5,:) = [];
    loading6.angle(end-4:end,:) = [];

fileName7 = ['upperangles' 'interactionfieldsize' num2str(2.2) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
    
    loading7 = load(fileName7);
    loading7.angle(1:5,:) = [];
    loading7.angle(end-4:end,:) = [];

fileName8 = ['upperangles' 'interactionfieldsize' num2str(2.4) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
    
    loading8 = load(fileName8);
    loading8.angle(1:5,:) = [];
    loading8.angle(end-4:end,:) = [];
    
fileName9 = ['upperangles' 'interactionfieldsize' num2str(2.6) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
    
    loading9 = load(fileName9);
    loading9.angle(1:5,:) = [];
    loading9.angle(end-4:end,:) = [];

fileName10 = ['upperangles' 'interactionfieldsize' num2str(2.8) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
    
    loading10 = load(fileName10);
    loading10.angle(1:5,:) = [];
    loading10.angle(end-4:end,:) = [];

fileName11 = ['upperangles' 'interactionfieldsize' num2str(3.0) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
    
    loading11 = load(fileName11);
    loading11.angle(1:5,:) = [];
    loading11.angle(end-4:end,:) = [];
    
fileName12 = ['upperangles' 'interactionfieldsize' num2str(3.2) 'eiratio' num2str(1.1) 'hering illusion sortbox1 upper part' '.mat'];
